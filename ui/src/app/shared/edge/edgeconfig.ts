...
export class EdgeConfig {
    ...
    public listAvailableFactories(): CategorizedFactories[] {
        let allFactories = [
            ...
            {
                category: { title: 'Energy Storage System (ESS)', icon: 'battery-charging-outline' },
                factories: [
            ...
            {
                category: { title: 'EV Charging Stations', icon: 'car-outline' },
                factories: [
            ...
            {
                category: { title: 'Cloud Interfaces', icon: 'cloud-outline' },
                factories: [
                    this.getFactoriesByIdsPattern([
                        /TimeOfUseTariff\.*/,
                    ]),
