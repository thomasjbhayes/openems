...
import io.openems.backend.metadata.gridvolt.postgres.PgUtils;
...
public class EdgeCache {
	...
	public EdgeCache(MetadataGridvolt parent) {
		this.parent = parent;
	}
	...
	public synchronized MyEdge addOrUpdate(ResultSet rs) throws SQLException, OpenemsException {
		// simple fields
		var edgeId = PgUtils.getAsString(rs, EdgeDevice.ID);
		...
		if (edge == null) {
			...
			edge = new MyEdge(this.parent, edgeId, apikey, comment, version, producttype, lastmessage);
