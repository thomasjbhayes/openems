...
import io.openems.backend.metadata.gridvolt.EdgeCache;
...
public class PostgresHandler {
	...
	public final PgUserHandler user;
	...
	public PostgresHandler(MetadataGridvolt parent, EdgeCache edgeCache, Config config, Runnable onInitialized)
			throws SQLException {
		this.parent = parent;
		this.edgeCache = edgeCache;
		this.dataSource = this.getDataSource(config);
		this.edge = new PgEdgeHandler(this.dataSource);
		this.user = new PgUserHandler(this.dataSource);
